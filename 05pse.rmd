...
```{r match, fig.cap="Flujo general del proceso de emparejamiento en la PES", out.width="100%", fig.align='center', echo=FALSE}
...
```{r match1q, fig.cap="Flujo general del proceso de emparejamiento en la PES", out.width="100%", fig.align='center', echo=FALSE}
knitr::include_graphics("images/grafo.png")
...
# library(htmlwidgets)
# 
# outfile <- "images/grafo.png"
# saveWidget(a, "grafo.html", selfcontained = TRUE)
# webshot("grafo.html", file = outfile, vwidth = 800, vheight = 600)
# 
...
data(RLdata500)
knitr::kable(head(RLdata500), format = "markdown")
```
